...
calculoid.controller('CalcDetailCtrl',
	['$scope', 'Calc', 'Field', 'User', '$routeParams', '$location', '$sce', '$window', 'Chart', '$uibModal', '$filter',
	function ($scope, Calc, Field, User, $routeParams, $location, $sce, $window, Chart, $uibModal, $filter) {
	...
	$scope.editCalcField = function(field) {
		if ($scope.activeField === field) {
			$scope.activeField = {};
		} else {
